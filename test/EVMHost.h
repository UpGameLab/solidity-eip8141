...
private:
	...
	static evmc::Result precompileVerifyMLDSA(evmc_message const& _message) noexcept;
	static evmc::Result precompileVerifyMLDSAEth(evmc_message const& _message) noexcept;
