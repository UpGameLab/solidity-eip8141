...
private:
	...
	static evmc::Result precompileNTTForward(evmc_message const& _message) noexcept;
	static evmc::Result precompileNTTInverse(evmc_message const& _message) noexcept;
	static evmc::Result precompileNTTVecMulMod(evmc_message const& _message) noexcept;
	static evmc::Result precompileNTTVecAddMod(evmc_message const& _message) noexcept;
