...
std::map<std::string, Instruction, std::less<>> const solidity::evmasm::c_instructions =
{
	...
	{ "TXPARAMLOAD", Instruction::TXPARAMLOAD },
	{ "TXPARAMSIZE", Instruction::TXPARAMSIZE },
	{ "TXPARAMCOPY", Instruction::TXPARAMCOPY },
...
{   //                                                Add Args Ret SideEffects GasPriceTier
	...
	{Instruction::TXPARAMLOAD,    {"TXPARAMLOAD",     0,  3,   1,  false,      Tier::VeryLow}},
	{Instruction::TXPARAMSIZE,    {"TXPARAMSIZE",     0,  2,   1,  false,      Tier::Base}},
	{Instruction::TXPARAMCOPY,    {"TXPARAMCOPY",     0,  5,   0,  true,       Tier::VeryLow}},
